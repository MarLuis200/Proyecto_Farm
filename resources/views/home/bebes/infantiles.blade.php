...
@section('content')
<title>Alimentos Infantiles</title>
                ...
                <main class="main-content">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/bebes">Bebes</a></li>
                            <li class="breadcrumb-item"><a>Alimentos Infantiles</a></li>
                        </ol>
                    </nav>

                        
                    <body>
                        <h1>Alimentos Infantiles</h1>
