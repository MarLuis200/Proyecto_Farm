                ...
                <main>
                    ...
                    <section id="productos">
                        ...
                        <div class="productos-container">
                            <div class="producto">
                                <img src="/img/vitacilina.jpg" class="img-fluid" width="200" height="200" alt="Producto 1">
                            ...
                            <div class="producto">
                                ...
                                <a class="nav-link" href="#"><h3>Xl-3 Xtra</h3>
                                <p>Antigripal Gripa/Tos CAP C/12</p>
                                <p>Precio: $64.00 MXN</p>
                            </div>
                            <div class="producto">
                                <img src="/img/tukol.jpg" class="img-fluid" width="200" height="200" alt="Producto 4">
                                <a class="nav-link" href="#"><h3>Tukol-D</h3>
                                <p>Miel 2.0 g/0.2 g Guaifenesina, Dextrometorfano Adulto 120 ml Frasco</p>
                                <p>Precio: $175.00 MXN</p>
                            </div>
                            <div class="producto">
                                <img src="/img/fisopred.jpg" class="img-fluid" width="200" height="200" alt="Producto 5">
                                <a class="nav-link" href="#"><h3>Fisopred 100 mg</h3>
